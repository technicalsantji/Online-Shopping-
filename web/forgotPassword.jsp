            ...
            <div class="mycard">
                <div class="row align-items-center">
                    <div class='signup col-md-6'data-aos="flip-left" >
                        <div class="mylfcard">
                            <form id="reg" action="forgotPassword" method="post" class="myform text-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="question" class="myinput" required>
                                ...
                                <div class="form-group">
                                   <i class="fa fa-lock" aria-hidden="true"></i>
                                    <input class="myinput" type="password" placeholder="New Password" name="password" id="password" required>
                                </div>
                                ...
                                <input id="btn-sum" type="submit" class="butt"  value="Update">
                            </form>
                        </div>
                    </div>
                    <div class='col-md-6'>
